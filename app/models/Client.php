...
class Client{
    ...
    private function add(){
        ...
        $statement = $db->prepare("INSERT INTO tbl_client "
                . "values(:id, :name, :dob, :email, :phone, :city, :createdBy, "
                . ":updatedBy, :createdDate, :updatedDate, :note);");
    ...
    public function getClients(){
        $db = db_connect();
        $statement = $db->prepare("select *, cl.name as client_name, "
                . "ci.name as city_name, cl.id as client_id "
